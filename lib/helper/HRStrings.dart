class HRStrings {
  ...
  static String userEmail = "Email Address";
  static String forgetPw = "Forgot Password ?";
  static String click = "Click";
  static String epfnumber = "EPF Number";
