...
class ContactUsMobileScreen extends StatefulWidget {
  const ContactUsMobileScreen({Key? key}) : super(key: key);
  ...
  @override
  State<ContactUsMobileScreen> createState() => _ContactUsMobileScreenState();
}

class _ContactUsMobileScreenState extends State<ContactUsMobileScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: ContactUsMobileScreen._pageBg,
      body: SafeArea(
        child: Column(
          children: [
            // Header
            Padding(
              padding: const EdgeInsets.fromLTRB(ContactUsMobileScreen._g12, ContactUsMobileScreen._g16, ContactUsMobileScreen._g12, ContactUsMobileScreen._g8),
              child: Row(
                children: [
                  InkWell(
                  ...
                  const SizedBox(width: ContactUsMobileScreen._g12),
                   Expanded(
                    child: AutoSizeText(
            ...
            Expanded(
              child: ListView(
                padding: const EdgeInsets.all(ContactUsMobileScreen._g16),
                children: [
                  // Hero banner
                  Container(
                    ...
                    decoration: BoxDecoration(
                      gradient: LinearGradient(
                        colors: [HRColors.darkOrangeColor.withOpacity(0.75), HRColors.orangeColor],
                    ...
                    child: Column(
                      ...
                      children:  [
                        ...
                        SizedBox(height: ContactUsMobileScreen._g12),
                        AutoSizeText(
                          AppLocalizations.of(context)!.weAreHere,
                          style: TextStyle(color: Colors.white, fontSize: 22, fontWeight: FontWeight.w800),
                        ),
                        SizedBox(height: ContactUsMobileScreen._g4),
                        AutoSizeText(
                          AppLocalizations.of(context)!.reachOut,
                  ...
                  const SizedBox(height: ContactUsMobileScreen._g24),

                   _SectionLabel(label: AppLocalizations.of(context)!.getInTouch),
                  const SizedBox(height: ContactUsMobileScreen._g12),
                  ...
                  const SizedBox(height: ContactUsMobileScreen._g8),
                  _ContactTile(
                  ...
                  const SizedBox(height: ContactUsMobileScreen._g24),
                  _SectionLabel(label: AppLocalizations.of(context)!.office),
                  const SizedBox(height: ContactUsMobileScreen._g12),

                  Container(
                    padding: const EdgeInsets.all(ContactUsMobileScreen._g16),
                    decoration: BoxDecoration(
                      color: ContactUsMobileScreen._surface,
                        ...
                        const SizedBox(width: ContactUsMobileScreen._g12),
                         Expanded(
                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              AutoSizeText(AppLocalizations.of(context)!.headOffice, style: TextStyle(fontWeight: FontWeight.w700, fontSize: 14, color: Colors.black87)),
                              SizedBox(height: ContactUsMobileScreen._g4),
                  ...
                  const SizedBox(height: ContactUsMobileScreen._g24),
                  _SectionLabel(label: AppLocalizations.of(context)!.businessHours),
                  const SizedBox(height: ContactUsMobileScreen._g12),

                  _HoursRow(day: AppLocalizations.of(context)!.weekdays, hours: '8:30 AM – 5:30 PM'),
                  _HoursRow(day: AppLocalizations.of(context)!.saturday, hours: '8:30 AM – 1:30 PM'),
                  _HoursRow(day: AppLocalizations.of(context)!.sunday, hours: 'Closed', isOff: true),
