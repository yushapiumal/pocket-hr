...
class _TabletHomeState extends State<TabletHome>
  ...
  String afternoonBg =
      "https://www.skymetweather.com/content/wp-content/uploads/2021/10/Things-To-Do-On-A-Sunny-Afternoon-fb.jpg";
  ...
  getTime() {
    ...
    final String formattedDateTime =
        DateFormat("d'$suffix' MMM yyyy - kk:mm:ss")
            .format(DateTime.now())
            .toString();
                              ...
                              Flexible(
                                child: SingleChildScrollView(
                                  child: Align(
                                    ...
                                    child: Padding(
                                      padding:
                                          EdgeInsets.only(left: 20.0, top: 1.0),
                                      child: Text(
                                        address ?? "loading...",
                                        style: TextStyle(
                                            color: HRColors.black,
